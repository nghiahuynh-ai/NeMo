    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        if "loss_list" in self._cfg:
            ...
            for decoder_loss_name, decoder_loss_cfg in self._cfg.loss_list.items():
                new_decoder_loss = {
                    'decoder': Denoising.from_config_dict(decoder_loss_cfg.decoder),
                    'loss': Denoising.from_config_dict(decoder_loss_cfg.loss),
                }
            ...
            self.decoder_ssl = Denoising.from_config_dict(self._cfg.decoder)
            self.loss = Denoising.from_config_dict(self._cfg.loss)

        self.spec_augmentation = Denoising.from_config_dict(self._cfg.spec_augment)
